 ...
 * @author DAM2Alu10
 */
public class JFrameLookAndFeel extends javax.swing.JFrame {

    /**
     * Creates new form JFrameLookAndFeel
     */
    public JFrameLookAndFeel() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameLookAndFeel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameLookAndFeel().setVisible(true);
            }
        });
    }
